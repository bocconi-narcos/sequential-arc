...
def main():
    ...
    parser.add_argument("--mode", type=str, choices=["challenge", "random", "mixed"], default="challenge",
                        help="Data source: 'challenge' for dataset, 'random' for random grids, 'mixed' for a mix of random and challenge grids.")
