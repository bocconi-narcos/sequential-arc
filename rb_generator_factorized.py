...
def main():
    ...
    parser.add_argument("--max_grid_dim_h", type=int, default=5,
                        help="Max height for initial grids."
    )

    parser.add_argument("--max_grid_dim_w", type=int, default=5,
        ...
        for _step in range(args.num_steps_per_grid):
            ...
            try:
                ...
                replay_buffer.append((
                    ...
                    action,  # This is now a dictionary with "colour", "selection", "transform"
                    reward,
