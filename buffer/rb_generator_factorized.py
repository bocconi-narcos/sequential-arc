# NOTE: This script now requires a YAML config file at 'buffer/buffer_config.yaml'.
...
def main():
    ...
    filename = f"rb_{config['mode']}_{config['buffer_size']}_{config['canvas_size']}_{config['action_preset']}.h5"
