...
def solve(space: ARCActionSpace) -> List[int]:
    ...
    return [
        # example:
        space.encode(colour='most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
        space.encode(colour='most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
        space.encode(colour='second_most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
        space.encode(colour='second_most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
        space.encode(colour='second_most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
        space.encode(colour='second_most_independent_cells', selection="independent_cells_4", transform="new_colour_1", key=key),
    ]
